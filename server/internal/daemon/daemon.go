...
type Daemon struct {
	...
	activeStores     map[string]int  // persistent store path (Codex per-issue sessions, Hermes per-agent memories) -> live-task refcount; guards the store from GC mid-task (MUL-4424)
